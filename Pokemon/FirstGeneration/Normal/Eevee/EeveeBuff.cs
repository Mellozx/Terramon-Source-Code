...
namespace Terramon.Pokemon.FirstGeneration.Normal.Eevee
{
    public class EeveeBuff : ModBuff
    {
        public override void SetDefaults()
        {
            ...
            Description.SetDefault("An Eevee is following you around!");
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            {
                Projectile.NewProjectile(player.position.X + player.width / 2, player.position.Y + player.height / 2, 0f, 0f, mod.ProjectileType("Eevee"), 0, 0f, player.whoAmI, 0f, 0f);
            }
