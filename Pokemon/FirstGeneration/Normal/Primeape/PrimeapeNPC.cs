...
{
    public class PrimeapeNPC : NotCatchablePKMN
    { public override string Texture => "Terramon/Pokemon/FirstGeneration/Normal/Primeape/Primeape";
        public override Type HomeClass()
        {
            return typeof(Primeape);
        }
