...
{
    public class RapidashNPC : NotCatchablePKMN
    { public override string Texture => "Terramon/Pokemon/FirstGeneration/Normal/Rapidash/Rapidash";
        public override Type HomeClass()
        {
            return typeof(Rapidash);
        }
