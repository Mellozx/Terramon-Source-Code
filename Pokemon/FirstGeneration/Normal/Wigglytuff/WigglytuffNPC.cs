...
{
    public class WigglytuffNPC : NotCatchablePKMN
    { public override string Texture => "Terramon/Pokemon/FirstGeneration/Normal/Wigglytuff/Wigglytuff";
        public override Type HomeClass()
        {
            return typeof(Wigglytuff);
        }
