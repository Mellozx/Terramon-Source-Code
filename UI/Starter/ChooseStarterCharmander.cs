...
namespace Terramon.UI.Starter
{
    ...
    internal class ChooseStarterCharmander : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            UIHoverImageButton
                bulbasaurTextureButton =
                    new UIHoverImageButton(bulbasaurTexture, "Bulbasaur"); // Localized text for "Close"
            ...
            UIImagez charmanderTextureButton = new UIImagez(charmanderTexture); // Localized text for "Close"
            ...
            Texture2D charmanderTextTexture = ModContent.GetTexture("Terramon/UI/PossibleAssets/CharmanderText");
            ...
            UIHoverImageButton choose = new UIHoverImageButton(chooseTexture, "Choose Charmander!");
